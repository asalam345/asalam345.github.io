    ...
    d.flexslider = function (j, l) {
                    ...
                    function (k) {
                        a.animating
                            ...
                            : 1 === k.touches.length &&
                              ...
                              (e = m ? k.touches[0].pageX : k.touches[0].pageY),
                              j.addEventListener("touchmove", b, !1),
            ...
            resize: function () {
                !a.animating &&
                    ...
                    s
                        ...
                        : (c.smoothHeight && f.smoothHeight(), a.newSlides.width(a.computedW), a.setProps(a.computedW, "setTotal")));
            },
        ...
        a.flexAnimate = function (b, g, p, j, l) {
            ...
            if (!a.animating && (a.canAdvance(b, l) || p) && a.is(":visible")) {
                if (t && j)
                    if (
                        ((p = d(c.asNavFor).data("flexslider")),
                        (a.atEnd = 0 === b || b === a.count - 1),
                        p.flexAnimate(b, !0, !1, !0, l),
                ...
                if (s)
                    q
                        ...
                        : (a.slides.eq(a.currentSlide).fadeOut(c.animationSpeed, c.easing), a.slides.eq(b).fadeIn(c.animationSpeed, c.easing, a.wrapup));
                else {
                    var r = m ? a.slides.filter(":first").height() : a.computedW;
                    h
                        ? ((b = c.itemWidth > a.w ? 2 * c.itemMargin : c.itemMargin), (b = (a.itemW + b) * a.move * a.animatingTo), (b = b > a.limit && 1 !== a.visible ? a.limit : b))
                        : (b =
                              0 === a.currentSlide && b === a.count - 1 && c.animationLoop && "next" !== a.direction
                                  ? n
                                      ? (a.count + a.cloneOffset) * r
                                      : 0
        ...
        a.canAdvance = function (b, g) {
            ...
            return g
                ? !0
                : t && a.currentItem === a.count - 1 && 0 === b && "prev" === a.direction
                ? !0
                : t && 0 === a.currentItem && b === a.pagingCount - 1 && "next" !== a.direction
                ? !1
                : b === a.currentSlide && !t
                ? !1
                : c.animationLoop
            ...
            if (s)
                a.slides.css({ width: "100%", float: "left", marginRight: "-100%", position: "relative" }),
                    "init" === b &&
                        (q
                            ? a.slides
                                  .css({ opacity: 0, display: "block", webkitTransition: "opacity " + c.animationSpeed / 1e3 + "s ease", zIndex: 1 })
                                  .eq(a.currentSlide)
                ...
                "init" === b &&
                    ...
                    (a.cloneCount = 0),
                    (a.cloneOffset = 0),
                    n && ((p = d.makeArray(a.slides).reverse()), (a.slides = d(p)), a.container.empty().append(a.slides)));
                c.animationLoop &&
                    !h &&
                    ((a.cloneCount = 2), (a.cloneOffset = 1), "init" !== b && a.container.find(".clone").remove(), a.container.append(a.slides.first().clone().addClass("clone")).prepend(a.slides.last().clone().addClass("clone")));
        ...
        a.doMath = function () {
            ...
            h
                ? ((a.itemT = c.itemWidth + d),
                  ...
                  (a.limit = 1 === a.pagingCount ? 0 : c.itemWidth > a.w ? (a.itemW + 2 * d) * a.count - a.w - d : (a.itemW + d) * a.count - a.w - d))
