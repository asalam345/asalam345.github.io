...
$(function () {
    ...
    $(function() {
        ...
        slider.on("click", ".flex-next", function(){
            var scrollSlider = $slideWrap.position().left - $('.info-slide-item').outerWidth();
            $slideWrap.animate({left: scrollSlider}, 500, function () {
                $slideWrap
                    .find('.info-slide-item:first')
                    .appendTo($slideWrap)
        ...
        slider.on("click", ".flex-prev", function(){
            var scrollSlider = $slideWrap.position().right - $('.info-slide-item').outerWidth();
            $slideWrap.animate({right: scrollSlider}, 500, function () {
                $slideWrap
                    .find('.info-slide-item:first')
                    .appendTo($slideWrap)
                    .parent()
